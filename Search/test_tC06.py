...
class TestTC06():
  ...
  def test_tC06(self):
    ...
    self.driver.find_element(By.ID, "myInput").click()
    self.driver.find_element(By.ID, "myInput").send_keys("AION")
    elements = self.driver.find_elements(By.LINK_TEXT, "AION")
    assert len(elements) > 0
    self.driver.find_element(By.ID, "myInput").send_keys("AOIN")
    elements = self.driver.find_elements(By.LINK_TEXT, "AION")
    assert len(elements) == 0
    self.driver.close()
